...
# Create a GUI window
gui = Tk()
gui.configure(bg="#0d1d2b")
gui.title("ToDo App")
gui.geometry("340x480")

# Widgets
enterTask = Label(gui, text="Enter Your Task", bg="#0d1d2b", width=20, fg="white" ,font=("lucida calligraphy", 16))
enterTaskField = Entry(gui, width=30, font=("Arial", 12))
Submit = Button(gui, text="Add Task", fg="white", bg="darkcyan",width=10, height=1,font=("lucida calligraphy", 12), command=insertTask)
TextArea = Text(gui, height=10, width=30, font=("Arial", 12))
taskNumber = Label(gui, text="Delete Task Number", fg="white",font=("lucida calligraphy", 12), bg="#0d1d2b")
taskNumberField = Entry(gui, width=6, font=("lucida calligraphy", 12))
delete = Button(gui, text="Delete Task", fg="white", bg="tomato",width=10, height=1,font=("lucida calligraphy", 12), command=delete)
Exit = Button(gui, text="Exit", fg="black", bg="lightsteelblue",width=10, height=1,font=("lucida calligraphy", 12), command=gui.quit)
